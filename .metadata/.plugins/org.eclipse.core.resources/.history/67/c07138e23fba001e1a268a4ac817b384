 ...
 * Aquí si se pueden establecer los try-catch de la excepción que se definió en el mmétodo retirar
...
public class Cajero {
	public static void main(String[] args) {
		...
		try {
			...
			e.printStackTrace(); //Método de excepciones que imprime el seguimiento del flujo de la expeción
		}
