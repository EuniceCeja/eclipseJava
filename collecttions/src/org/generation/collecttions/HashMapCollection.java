...
public class HashMapCollection {
	public static void main(String[] args) {
		...
		//Agrega elementos "clave/valor" (.put)
		...
		//De esta manera ya se pueden utilizar los métodos de abajo
		for (Map.Entry<String, String> entry: capitals.entrySet()) { //entrySet para entrar al string
