...
public class Employee {
	...
	//2. Método Constructor. Tiene el mismo nombre que la clase, no retorna nada, recibe parámetross (atributos) y los asigna a variables del constructor (this)
	Employee(String nombre, String apellido, int id, double salario, String puesto){//al instanciar objetos, sigue este orden
