...
public class EmployeeMain {
	public static void main(String[] args) {
		...
		Employee Daniel = new Employee("Daniel", "Maldonado", 7836, 8596.33d, "Instrucctor");//numeros con d por double, para definir el tipo de dato. float f, long l
		Employee Abigail = new Employee("Abigail", "Martinez", 5274, 19754.20d, "Desarrolladora frontend");
		Employee Arturo = new Employee("Arturo", "Avila", 4403, 17999.62d, "Desarrolador backend");
		...
		//Necesitamos traer la información mediante getters ya que los atrbutos se convirtieron en privados
